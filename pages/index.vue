<template>
  <div>
    <!-- Hero Banner -->
    <section class="m-hero w-full flex items-center py-8 md:py-16 lg:py-32 mb-10 md:mb-12" style="background: url(/images/100@2x.jpg) no-repeat center center #ECADAD; background-size: cover;">
